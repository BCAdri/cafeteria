export const Footer = () => {
    return (
        <footer className="container-fluid bg-gray-800 text-center">
            <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-2">
                <div>
            ...
            <div className="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-300 md:mx-auto">
                    © 2024 SimCafs. All Rights Reserved.
                </span>
            </div>
        </footer>
    );
